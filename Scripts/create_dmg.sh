...
legacy_app_path="$distribution_dir/VideoBox.app"
...
app_path="$staging_root/VideoBox.app"
mount_point=""
is_mounted=0
...
VIDEOBOX_APP_OUTPUT_PATH="$app_path" "$script_dir/package_app.sh" "$configuration"
